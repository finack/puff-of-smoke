...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create puff-of-smoke-e0c5
  fly apps create puff-of-smoke-e0c5-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app puff-of-smoke-e0c5
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app puff-of-smoke-e0c5-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'puff-of-smoke-e0c5-staging' does not match app name in config file 'puff-of-smoke-e0c5'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name puff-of-smoke-e0c5-db
  fly postgres attach --app puff-of-smoke-e0c5 puff-of-smoke-e0c5-db

  fly postgres create --name puff-of-smoke-e0c5-staging-db
  fly postgres attach --app puff-of-smoke-e0c5-staging puff-of-smoke-e0c5-staging-db
  ```
